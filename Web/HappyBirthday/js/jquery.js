...
(function (e, t) {
  ...
  function z(e, t, r, i) {
    ...
    return (
      ...
      typeof t == "string"
        ? ((s = o[t]), s == null && (s = o[p.camelCase(t)]))
        : (s = o),
      s
    );
  }
  ...
  function Qt(e, t, n, r, i) {
    ...
    for (; s < 4; s += 2)
      n === "margin" && (o += p.css(e, n + V[s], !0, i)),
        r
          ? (n === "content" && (o -= p.css(e, "padding" + V[s], !0, i)),
            n !== "margin" && (o -= p.css(e, "border" + V[s] + "Width", !0, i)))
  ...
  function ln(e, t, n) {
    ...
    n.queue ||
      ...
      e.nodeType === 1 &&
        ...
        f === "inline" &&
          p.css(e, "float") === "none" &&
          (!c.inlineBlockNeedsLayout || l === "inline"
  ...
  (p.filter = function (e, t, n) {
    ...
    p.fn.extend({
      ...
      is: function (e) {
        return !!x(this, typeof e == "string" && w.test(e) ? p(e) : e || [], !1)
          .length;
      },
    });
  var T,
  ...
  p.extend({
    dir: function (e, t, n) {
      ...
      while (
        i &&
        i.nodeType !== 9 &&
        (n === undefined || i.nodeType !== 1 || !p(i).is(n))
      )
  ...
  (function () {
    ...
    t.setAttribute("className", "t"),
      ...
      (c.html5Clone =
        N.createElement("nav").cloneNode(!0).outerHTML !== "<:nav></:nav>"),
      (n.type = "checkbox"),
      (n.checked = !0),
      e.appendChild(n),
    ...
    (function () {
      function l() {
        ...
        (t = N.createElement("div")),
          ...
          p.swap(u, u.style.zoom != null ? { zoom: 1 } : {}, function () {
            r = n.offsetWidth === 4;
          }),
          (i = !0),
          (s = !1),
  ...
  p.extend({
    ...
    style: function (e, t, n, r) {
      ...
      if (n === undefined)
        return o && "get" in o && (i = o.get(e, !1, r)) !== undefined
          ? i
          : a[t];
      (s = typeof n),
        s === "string" &&
    ...
    p.each(["height", "width"], function (e, t) {
      p.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return e.offsetWidth === 0 && Rt.test(p.css(e, "display"))
          ...
          return Kt(
            ...
            r
              ? Qt(
                  ...
                  r,
                  c.boxSizing() &&
                    p.css(e, "boxSizing", !1, i) === "border-box",
                  i
                )
              : 0
          );
    ...
    (p.cssHooks.marginRight = Ft(c.reliableMarginRight, function (e, t) {
      if (t)
        return p.swap(e, { display: "inline-block" }, Bt, [e, "marginRight"]);
    })),
      ...
      attr: function (e, t, n) {
        ...
        if (n === undefined)
          return r && "get" in r && (i = r.get(e, t)) !== null
            ? i
            : ((i = p.find.attr(e, t)), i == null ? undefined : i);
        if (n !== null)
          return r && "set" in r && (i = r.set(e, n, t)) !== undefined
            ? i
    ...
    (p.expr.filters.hidden = function (e) {
      return (
        ...
        (!c.reliableHiddenOffsets() &&
          ((e.style && e.style.display) || p.css(e, "display")) === "none")
      );
    }),
